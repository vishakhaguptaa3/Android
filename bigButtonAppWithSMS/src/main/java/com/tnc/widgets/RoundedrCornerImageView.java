...
public class RoundedrCornerImageView extends ImageView {
	...
	public RoundedrCornerImageView(Context context, AttributeSet attrs, int defStyle) {
		...
		try {
			...
			Log.i("Access to parent private field failed","Access to parent private field failed");
		}
	}
 
	public RoundedrCornerImageView(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
	}
 
	public RoundedrCornerImageView(Context context) {
		super(context);
	}
