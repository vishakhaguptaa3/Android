...
public class GalleryAdapterResponse extends BaseAdapter 
{
	...
	public GalleryAdapterResponse(Context mContext,ArrayList<ImageItem> images,Cursor imageCursor,Uri[] mUrls,String[] strUrls,
...
//					MainBaseActivity._bitmap=BitmapFactory.decodeFile(mUrls[position].getPath(),options);
				...
				cropIntent.putExtra(CropImage.IMAGE_PATH,GlobalCommonValues.selectedImagepath);
