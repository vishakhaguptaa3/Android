...
public class GetBBIDResponseBean 
{
	...
	@SerializedName("data")
	public GetBBIDResponseBeanData data ;

	public GetBBIDResponseBeanData getResponseData()
	{
		return data;
	}
	 ...
	 * @return the data
	 */
	public GetBBIDResponseBeanData getData() {
		return data;
	}
	 ...
	 */
	public void setData(GetBBIDResponseBeanData data) {
		this.data = data;
	}
}
