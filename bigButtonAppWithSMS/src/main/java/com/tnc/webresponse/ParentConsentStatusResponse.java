...
public class ParentConsentStatusResponse {
	...
	@SerializedName("data")
	public ArrayList<ParentConsentStatusResponseData> data;
	 ...
	 * @return the data
	 */
	public ArrayList<ParentConsentStatusResponseData> getData() {
		return data;
	}
	 ...
	 */
	public void setData(ArrayList<ParentConsentStatusResponseData> data) {
		this.data = data;
	}
}
