...
public class VerifyRegistrationResponse {
	...
	@SerializedName("data")
	public VerifyRegistrationResponseDataBean data;
	 ...
	 * @return the data
	 */
	public VerifyRegistrationResponseDataBean getData() {
		return data;
	}
	 ...
	 */
	public void setData(VerifyRegistrationResponseDataBean data) {
		this.data = data;
	}
}
