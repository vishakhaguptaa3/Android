...
public class CheckNumberResponseBean {
	...
	@SerializedName("data")
	public CheckNumberResponseDataBean data;
	 ...
	 * @return the data
	 */
	public CheckNumberResponseDataBean getData() {
		return data;
	}
	 ...
	 */
	public void setData(CheckNumberResponseDataBean data) {
		this.data = data;
	}
}
